 ...
 * @author nakib
 */
public class UploadplayerhealthinfoController implements Initializable {
    ...
    @FXML
    private TextArea playerhealthtextarea;
    ...
    private void uploadonclick(ActionEvent event) throws IOException {
        ...
        a.setContentText("Player Health Info will Submit");
        a.showAndWait();
        
        //Clear the text fild after click submit button
        playeridtextfild.clear();
        playerhealthtextarea.clear();
    }
