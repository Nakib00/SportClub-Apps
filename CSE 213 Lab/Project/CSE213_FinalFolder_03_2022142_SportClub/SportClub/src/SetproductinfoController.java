 ...
 * @author nakib
 */
public class SetproductinfoController implements Initializable {
    ...
    @FXML
    private TextField typetextfild;
    @FXML
    private TextField pricetextfild;
    @FXML
    private TextField availabitytextfild;
    ...
    private void uploadbuttonclick(ActionEvent event) throws IOException {
        ...
        f = new File("MarchandisProductinfo.txt"); 
        ...
        fw.write(
            	idtextfild.getText()+","
                +typetextfild.getText()+","	
                +pricetextfild.getText()+","	
                +availabitytextfild.getText()+"\n"
            );
        ...
        a.setContentText("Set Product Info will Submit");
        a.showAndWait();
